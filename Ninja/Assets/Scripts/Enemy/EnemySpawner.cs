    ...
    private void TryRaiseDifficulty()
    {
        if (_currentDifficultyIndex < difficultyRaiseTimes.Count)
        {
            if (_endGameManager.currentDuration >= difficultyRaiseTimes[_currentDifficultyIndex])
            {
                ...
                {
                    case 1:
                        RaiseDifficulty(0f, 0, 0, 0f, 0f);
                        break;
                    case 2:
                        RaiseDifficulty(0f, 1, 0, 0f, 0f);
                        break;
                    case 3:
                        RaiseDifficulty(0f, 0, 1, 0f, 0f);
                        break;
                    case 4:
                        RaiseDifficulty(0f, 0, 0, 0.5f, 0f);
                        break;
                    case 5:
                        RaiseDifficulty(0f, 0, 1, 0f, 0.5f);
                        break;
                    case 6:
                        RaiseDifficulty(0f, 1, 1, 0f, 0f);
                        break;
                    case 7:
                        RaiseDifficulty(0f, 0, 1, 0.5f, 0f);
                        break;
                    case 8:
                        RaiseDifficulty(0f, 0, 0, 0.5f, 0.5f);
                        break;
                    case 9:
                        RaiseDifficulty(0f, 1, 1, 0.5f, 0f);
                        break;
                }
            }
        }
